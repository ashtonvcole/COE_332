...
def get_redis_client():
    ...
    """
    return redis.Redis(host = 'ashtonc-test-gdb-rd-service', port = 6379, db = 0, decode_responses = True)
...
def genes():
    ...
    try:
        ...
        return f'ERROR: unable to get gene ID\'s', 400
...
def genes_gene_id(hgnc_id: str):
    ...
    try:
        ...
        return f'ERROR: unable to get gene.', 400
